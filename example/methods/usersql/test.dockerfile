...
ENV SQL_TEST_DB test_db
ENV SQL_TEST_USER test_user
ENV SQL_TEST_ADDR 0.0.0.0
ENV SQL_TEST_PORT 3306
ENV SQL_TEST_Driver mysq
ENV SQL_TEST_PASSWORD test_user_pass
ENV fork true
